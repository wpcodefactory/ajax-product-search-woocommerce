...
**Ajax Product Search for WooCommerce** is a plugin where users can search WooCommerce products using an autocomplete feature.
...
1. Upload the entire 'ajax-product-search-woocommerce' folder to the '/wp-content/plugins/' directory.
