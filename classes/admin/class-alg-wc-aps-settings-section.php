<?php
/**
 * Ajax Product Search for WooCommerce- Section Settings
 *
 * @version 1.0.0
 * @since   1.0.0
...
if ( ! class_exists( 'Alg_WC_APS_Settings_Section' ) ) :

	class Alg_WC_APS_Settings_Section {
		...
		function __construct( $handle_autoload = true ) {
			...
			add_filter( 'woocommerce_get_settings_alg_wc_aps_' . $this->id, array(
				$this,
				'get_settings',
			), PHP_INT_MAX );
		}
